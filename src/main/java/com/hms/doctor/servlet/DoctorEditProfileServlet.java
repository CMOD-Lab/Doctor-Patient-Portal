...
/**
 * DoctorEditProfileServlet - Cloud Readiness Fix: cr-java-0065 (HTTP Session State Storage)
 *
...
public class DoctorEditProfileServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// flash messages and the updated doctor object are available regardless of
			// which instance handles the redirect.
			...
			if (f == true) {
				...
				// Updated doctor object stored in Redis-backed session; overrides the old
				// session value so the profile page reflects the latest data.
