		...
		<div class="row">
			<div class="col-md-8 offset-md-2">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center text-success fs-3">Add Prescription</p>
						...
						<form action="../addPrescription" method="post">
							...
							<div class="mb-3">
								...
								<input type="text" name="prescriptionDate" class="form-control" required>
							</div>

							<button type="submit" class="btn btn-success col-md-12">Add Prescription</button>
						</form>
						<!-- End of Add Prescription Form -->
